...
public class Runner {
    ...
    public static void main(String[] args) {
        File csvFile = new File("C:\\Users\\MarcianSeeger\\Documents\\HyFD\\data\\hospital_clean.csv");
        ...
        // Use 1.0 for exact FDs.
        // Use e.g. 0.8 if you want approximate FDs from your modified HyFD.

        long startTime = System.nanoTime();

        List<Result> hyfdResults = executeHyFD(threshold, csvFile.getName());
